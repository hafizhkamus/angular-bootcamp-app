...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'combined-element',
        loadComponent: () => import('./demo/elements/combined-element/combined-element.component').then((c) => c.CombinedElementComponent)
      },
      {
        path: 'sample-page',
      ...
      {
        path: 'training-page',
        loadComponent: () => import('./demo/other/training-page/training-page.component').then((c) => c.TrainingPageComponent)
      },
      {
        path: 'data-murid',
        loadComponent: () => import('./demo/pages/data-murid/data-murid.component').then((c) => c.DataMuridComponent)
      }
    ]
  },
  {
